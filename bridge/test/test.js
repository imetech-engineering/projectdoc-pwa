...

{
  ...
  schrijfDocx(anderPad, p("Robot") + `<w:tbl>${tr("Projectnummer", "5020 │ Aluwi (via Fiverr)")}</w:tbl>`);
  ...
  check("platformnaam (Fiverr) koppelt niet op klant", robot.losseFacturen.some((f) => f.nummer === "FA260912"));
